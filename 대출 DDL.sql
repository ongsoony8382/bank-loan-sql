...
-- 기준 금리 이력 테이블
CREATE TABLE TB_BASE_RATE_HIST (
BASE_RATE_HIST_ID  BIGINT        NOT NULL COMMENT '기준 금리 이력 ID',
BASE_RATE_TP_CD    VARCHAR(10)   NOT NULL COMMENT '기준 금리 유형 코드',
...
-- 가산 금리 정책 테이블 
CREATE TABLE TB_ADD_INTR_RT_RULE (
...
-- 우대 금리 정책 테이블 
CREATE TABLE TB_PREF_INTR_RT_RULE (
